    ...
    public  void checkTile(Entity entity){
        ...
        switch (entity.direction){
            case "up":
                ...
                tileNum1=gp.tileM.mapTileNumber[entityLeftCol][entityTopRow];//on verifie les cases ou l'entité peu se heurter lorsqu'il avance dans une certaine direction,
